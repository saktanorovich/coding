...
public class Main {
    private static final class TheDominoEffect {
        public boolean process(int testCase, InputReader in, PrintWriter out) {
            ...
            out.format("Layout #%d:\n\n\n", testCase);
            dump(layout, out);
            out.format("Maps resulting from layout #%d are:\n\n\n", testCase);
            backtrack(0, 0, out);
            out.format("There are %d solution(s) for layout #%d.\n", count, testCase);
            return true;
        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length > 0 && args[0].equals("-g")) {
            ...
            for (int test = 1; in.hasNext(); ++test) {
                ...
                contd = new TheDominoEffect().process(test, in, out);
                out.flush();
